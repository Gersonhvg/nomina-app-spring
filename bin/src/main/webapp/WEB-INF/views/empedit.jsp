			...
			<div class="row justify-content-center mt">
				<div class="card " style="width: 40rem;">
					<div class="card-body">
						...
						<form action="${ id }" class="form formu" object="${ empleados }" method="post">
							<!--DNI-->
							<div class="row form-group">
								<label for="dni" class="col-form-label col-md-4">DNI</label>
								<div class="col-md-8">
									<input type="number" class="form-control" id="dni" name="dni" min="10000000" max="99999999" value="${ emp.dni }" readonly required />
								</div>
							</div>
							<!--Nombre-->
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" class="form-control" id="nombre" name="nombre" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ]{1, 255}" value="${ emp.nombre }" readonly required />
								</div>
							</div>
							<!--Apellido-->
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" class="form-control" id="apellido" name="apellido" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ]{1, 255}" value="${ emp.apellido }" readonly required />
								</div>
							</div>
							<!--correo-->
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="email" class="form-control" id="correo" name="correo" value="${ emp.correo }" required />
								</div>
							</div>
							<!--Dirección-->
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" class="form-control" id="direccion" name="direccion" value="${ emp.direccion }" required />
								</div>
							</div>
							<!--Nacimiento-->
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="date" class="form-control" id="nacimiento" name="nacimiento" max="2004-06-01" value="${ emp.nacimiento }" readonly required />
								</div>
							</div>
							<!--Género-->
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" class="form-control" id="genero" name="genero" value="${ emp.genero }" readonly required />
								</div>
							</div>
							<!--Ocupacion ID-->
							<div class="row form-group">
