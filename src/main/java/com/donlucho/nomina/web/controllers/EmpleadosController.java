...
public class EmpleadosController {
	...
	public ModelAndView manejadorVistaBonificacion() {
		String palabraClave = "";
		Map<String, Object> empleadoModel = new HashMap<>();
		empleadoModel.put("empleadosb", this.empleadoService.listarEmpleados(palabraClave));
	...
	public ModelAndView manejadorVistaDeduccion() {
		String palabraClave = "";
		Map<String, Object> empleadoModel = new HashMap<>();
		empleadoModel.put("empleadosd", this.empleadoService.listarEmpleados(palabraClave));
