					...
					<div class="card-body">
						...
						<form action="${ id }" class="form formu" object="${ deducciones }" method="post">
							...
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" class="form-control"  id="motivo" name="motivo" value="${ ded.motivo }" required />
								</div>
							</div>
							<!--Monto-->
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="number" class="form-control" id="monto" name="monto" min="0.01" max="999999999.99" step="0.01" value="${ ded.monto }" required />
								</div>
							</div>
							<!--Fecha-->
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="date" class="form-control" id="fecha" name="fecha" value="${ ded.fecha }" required readonly />
								</div>
							</div>
							<!--ID empleado-->
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="number" class="form-control" id="empleado.id" name="empleado.id"  min="1" max="999999" value="${ ded.empleado.id }" readonly required />
								</div>
							</div>
							<!--ID planilla-->
							<div class="row form-group">
